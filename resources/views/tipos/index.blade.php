...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tipos de Ocorrência</li>
       </ol>
    </section>
        ...
        $(document).ready(function(){
            ...
            $('#dados-tabela').DataTable({
                ...
                'fnDrawCallback': function (oSettings) {
                    $('.add').each(function () {
                        $(this).html(' <a href="{{ route('tipos.cadastrar') }}" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>');
                    });
                },
                ajax: {
                    'url' : '{!! route("tipos.dados") !!}'
                },
                columns: [
