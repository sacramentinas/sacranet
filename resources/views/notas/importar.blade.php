...
@section('breadcrumb')
    <section class="content-header">
        <h1>
            <i class="fa fa-user"></i> Importar Notas
        ...
        <div class="col-md-12">
            <div class="box box-info ">
                ...
                <div class="box-footer text-black">
                    <form action="{!! route('notas.upload') !!}" method="post" enctype="multipart/form-data" id="form">
                        <input type="hidden" name="_token" value="{!! csrf_token() !!}" >
                        <div class="input-group envio">
                            <input type="file" name="notas" id="notas" class="form-control" >
